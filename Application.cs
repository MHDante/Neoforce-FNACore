...
namespace TomShane.Neoforce.Controls
{
    public abstract class Application : Game
    {
        ...
        protected override void Initialize()
        {
            ...
            Manager.Game.Window.IsBorderlessEXT = !systemBorder;
        ...
        protected virtual void InitMainWindow()
        {
            if (mainWindow != null)
            {
                ...
                mainWindow.BorderVisible = mainWindow.CaptionVisible = (!systemBorder && !Graphics.IsFullScreen) ||
                                                                       (Graphics.IsFullScreen && fullScreenBorder);
        ...
        private void Input_MouseMove(object sender, MouseEventArgs e)
        {
            if (mouseDown)
            {
                WindowPosition = WindowPosition with { X = e.Position.X + WindowPosition.X - mousePos.X };
                WindowPosition = WindowPosition with { Y = e.Position.Y + WindowPosition.Y - mousePos.Y };
            }
        }
        ////////////////////////////////////////////////////////////////////////////
